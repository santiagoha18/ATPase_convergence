...
- The `rst` file contains the ASR output: posterior probabilities per site and reconstructed sequences (codeml - PAML)
- `A1-A3_AA_alignment_convergence_modified_codeml.fasta` --> sequence alignment of ATP1A gene family
- `codeml_brlens_tree.tre` --> phylogenetic tree of ATP1A gene family
...
```{r convergence, fig.width=7, fig.height=9}
