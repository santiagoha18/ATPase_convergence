...
![](BayesTraits_files/figure-markdown_github/parseBT-1.png)
...
![](BayesTraits_files/figure-markdown_github/parseBT-2.png)
...
```
    ...
    ## [1] "median distance of top 5% sites to site:  25.1018445  | Pval =  0"

``` r
null_dist_122 <- spatial_enrichment(spatial_BT_122,spatial_BT_122top5)
```

    ## [1] "median distance of top 5% sites to site:  34.0234085  | Pval =  0.011"
...
![](BayesTraits_files/figure-markdown_github/3dprot-1.png)
...
![](BayesTraits_files/figure-markdown_github/3dprot-2.png)
